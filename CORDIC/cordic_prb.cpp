...
//
{
    ...
    cout << "\n";
    cout << "TEST001:\n";
    cout << "  COSSIN_CORDIC computes the cosineh and sineh\n";
    cout << "  using the CORDIC algorithm.\n";
    cout << "\n";
    cout <<
         "          A        N      Tanh(A)           Tanh(A)           Difference\n";
    ...
    for ( ; ; )
    {
        cosh_values ( &n_data, &a, &c1 );
        sinh_values(&n_data,&a,&s1);
        tanh_values(&n_data,&a,&t1);
