...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.coshsinh_cordic.autotvin_beta.dat"
         "c.coshsinh_cordic.autotvin_m.dat"
         "c.coshsinh_cordic.autotvin_n.dat"
         "c.coshsinh_cordic.autotvout_ch.dat"
         "c.coshsinh_cordic.autotvout_sh.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.coshsinh_cordic.autotvout_ch.dat"
         "rtl.coshsinh_cordic.autotvout_sh.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
