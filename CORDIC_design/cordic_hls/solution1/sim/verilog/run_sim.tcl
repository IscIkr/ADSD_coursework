...
if {[file isfile coshsinh_cordic.autotvin.dat]} {
	file delete -force coshsinh_cordic.autotvin.dat
}

if {[file isfile coshsinh_cordic.autotvout.dat]} {
	file delete -force coshsinh_cordic.autotvout.dat
}
