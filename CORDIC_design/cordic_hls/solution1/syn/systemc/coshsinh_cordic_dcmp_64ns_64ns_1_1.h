...
#ifndef __coshsinh_cordic_dcmp_64ns_64ns_1_1__HH__
#define __coshsinh_cordic_dcmp_64ns_64ns_1_1__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(coshsinh_cordic_dcmp_64ns_64ns_1_1) {
    ...
    SC_CTOR(coshsinh_cordic_dcmp_64ns_64ns_1_1):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
